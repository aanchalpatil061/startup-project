...
import { BRANCHES, YEARS, SECTIONS } from '../../../src/constants/config';
...
export default function StudentSignupScreen() {
  ...
  const [form, setForm] = useState({
    ...
    branch: BRANCHES[0], year: YEARS[0], section: SECTIONS[0],
  ...
  const signupMutation = useMutation({
    mutationFn: authApi.signupStudent,
    onSuccess: async (res) => {
    ...
    <KeyboardAvoidingView style={styles.flex} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
      ...
      >
        ...
        <View style={styles.form}>
          <Input label="Full Name" placeholder="Your full name" value={form.name} onChangeText={set('name')} leftIcon="person-outline" error={errors.name} />
          ...
          <Input label="Roll Number" placeholder="e.g. 21CS001" value={form.rollNumber} onChangeText={set('rollNumber')} autoCapitalize="characters" leftIcon="id-card-outline" error={errors.rollNumber} />

          <View style={styles.field}>
            <Text style={styles.label}>Branch</Text>
            <View style={styles.pickerWrapper}>
              <Picker selectedValue={form.branch} onValueChange={set('branch')} style={styles.picker}>
          ...
          <View style={styles.row}>
            <View style={[styles.field, styles.flex]}>
              ...
              <View style={styles.pickerWrapper}>
                <Picker selectedValue={form.year} onValueChange={set('year')} style={styles.picker}>
            ...
            <View style={[styles.field, { width: 100 }]}>
              ...
              <View style={styles.pickerWrapper}>
                <Picker selectedValue={form.section} onValueChange={set('section')} style={styles.picker}>
                  {SECTIONS.map((s) => <Picker.Item key={s} label={`Section ${s}`} value={s} />)}
                </Picker>
              </View>
            </View>
          </View>
        ...
        <View style={styles.signinRow}>
          ...
          <TouchableOpacity onPress={() => router.replace('/(auth)/login/student')}>
